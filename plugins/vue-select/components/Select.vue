...
<template>
  <div class="select-wrapper" :class="dropdownClasses">
    ...
    <transition :name="transition">
      <ul v-if="dropdownOpen" class="dropdown-content select-dropdown active">
        <li v-if="this.placeholder" class="disabled"><span v-text="this.placeholder"></span></li>
        <li v-for="(option, index) in filteredOptions" v-bind:key="index" :class="{ active: isOptionSelected(option) }">
